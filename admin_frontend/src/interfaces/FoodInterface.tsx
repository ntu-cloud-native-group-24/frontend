...
export interface FoodSingleSelectionType {
    title: string;
    selections: Array<FoodSelectionType>;
}

export interface FoodMultipleSelectionType {
    title: string;
    selections: Array<FoodSelectionType>;
}
...
export interface FoodType {
    ...
    name: string;
    price: number;              // money $
    status: boolean;            // onStock or soldOut
...
export const dummyData: FoodType[] = [
    ...
    },
    {
        ...
        picture: 'https://www.allrecipes.com/thmb/G96Vc_7F5Dm0csJJb2STC6tO97k=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/79543-fried-rice-restaurant-style-mfs-49-79b33da67e2643e8b585972cd92c5821.jpg',
        tags: [
            'RICE',
            'FOOD',
        ],
    ...
    },
    {
        ...
        soldAmount: 900,
        description: '咖啡牛奶版',
        picture: 'https://neurosciencenews.com/files/2023/06/coffee-brain-caffeine-neuroscincces.jpg',
        tags: [
            'DRINK',
            'COFFEE'
        ],
    ...
    },
    {
        ...
        picture: 'https://images.chinatimes.com/newsphoto/2019-01-21/656/20190121001620.png',
        tags: [
            'DRINK',
        ],
        singleSelections: [],
    ...
    },
    {
        ...
        soldAmount: 99,
        description: '披薩的升級版',
        picture: 'https://a57.foxnews.com/static.foxnews.com/foxnews.com/content/uploads/2021/06/1200/675/iStock-1222455274.jpg?ve=1&tl=1',
        tags: [
            'PIZZA',
            'FOOD',
        ],
    ...
    },
    {
        ...
        soldAmount: 580,
        description: '糯米雞的朋友',
        picture: 'https://tokyo-kitchen.icook.network/uploads/step/cover/915480/5a9b0a387754fd7a.jpg',
        tags: [
            'RICE',
            'FOOD',
        ],
    ...
    },
    {
        ...
        soldAmount: 10,
        description: '超難吃的東西',
        picture: 'https://cdn.apartmenttherapy.info/image/upload/f_auto,q_auto:eco,c_fill,g_center,w_730,h_487/k%2Farchive%2F3a159785f764bff9cd80202b094f9b7a65da99e7',
        tags: [
            'DESSERT',
            'FOOD',
        ],
